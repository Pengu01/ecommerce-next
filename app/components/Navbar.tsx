...
const Navbar = () => {
    ...
    return (
        <>  
        <div className={`ease-in-out duration-1000 transition-all w-full flex justify-center fixed z-30 top-0 categoryanim`}>
            <div className={`flex justify-between gap-8 ease-in-out duration-1000 delay-1000 bg-top transition-all bg-gradient-to-t from-[--rmain-color] to-[--rmain-color] bg-no-repeat w-full bg-[length:100%_100%] backgroundanim`}>
